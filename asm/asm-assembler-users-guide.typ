...
#title-page(
  title-text: [
    _CP/M® Assembler (ASM) \ User's Guide_
  ],
...
- #link("http://cpm.z80.de/randyfiles/DRI/ASM.pdf")[_CP/M Assembler (ASM) User's Guide_ (pdf)]

Additional documents are from #link("https://bitsavers.org/")[bitsavers.org].

- #link("https://bitsavers.org/pdf/digitalResearch/cpm/1.4/CPM_1.4_Assembler_Users_Guide_1978.pdf")[CPM_1.4_Assembler_Users_Guide_1978.pdf]
