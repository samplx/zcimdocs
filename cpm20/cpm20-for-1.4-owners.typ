...
#title-page(
  title-text: [
Digital Research \
    _CP/M® 2.0 User's Guide for CP/M 1.4 Owners_
  ],
...
= Console Command Processor (CCP) Interface
...
- #link("- #linkhttp://cpm.z80.de/randyfiles/DRI/CPM_2_0_UG_for_CPM_1_4_Users.pdf")[_CP/M 2.0 User's Guide for CP/M 1.4 Owners_ (pdf)]
