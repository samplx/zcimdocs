...
#title-page(
  title-text: [
    _CP/M® 2 Introduction to \ Features and Facilities_
  ],
...
notify any person of such revision or changes.    
  ...
  trademarks: [
    CP/M is a registered trademark of Digital Research. MP/M, MAC and SID
    are trademarks of Digital Research.
  ],
  printing: [
    Revision of November 15, 1979 \
...
Original source material is from the
...
- #link("http://cpm.z80.de/randyfiles/DRI/Intro_to_CPM_Feat_and_Facilities.pdf")[_An Introduction to CP/M Features and Facilities_ (pdf)]

Additional source material is from #link("https://archive.org")[archive.org].

- #link("https://archive.org/download/cpm-features-facilities/Image071617192829.duplex.pdf")[CP/M 2 Introduction to Features and Facilities]
