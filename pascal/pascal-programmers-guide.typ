...
Copyright © 2025 by James Burlingame.
  ...
  trademarks: [
    ...
    Pascal/MT+, DIS8080, LIBMT+, LINK/MT+, LINK-80, RMAC, and SID are trademarks of Digital Research.
  ...
  ,
  printing: [
    The original document was prepared using the Digital Research `TEX` Text Formatter, \
