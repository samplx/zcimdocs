...
ASM, DDT, MAC and SID are trademarks of Digital
Research. Intel is a registered trademark of Intel
Corporation.
  ],
  printing: [
    The original "SID User's Guide" was prepared using the
Digital Research TEX Text Formatter and printed in
the United States of America by Commercial
Press/Monterey. \
...
- #link("http://cpm.z80.de/manuals/sid.zip")[_SID The CP/M Symbolic Debugger_ (zipped text file)]
- #link("http://cpm.z80.de/manuals/sid1978.zip")[_SID 1978 version_ (zipped text file)]
